 ...
 */
public class GroupedDataStream<K, T> implements Publisher<Data<T>> {

  private final K key;
  private final Publisher<Data<T>> items;

  public GroupedDataStream(K key, Publisher<Data<T>> items) {
